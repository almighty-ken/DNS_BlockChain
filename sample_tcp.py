#!/usr/bin/env python
# extracted and modified from https://gist.github.com/samuelcolvin/ca8b429504c96ee738d62a798172b046
...
# sys.path.insert(0, os.path.expanduser('/Users/ken/Desktop/CPSC526/DNS_BlockChain/dnslib'))
